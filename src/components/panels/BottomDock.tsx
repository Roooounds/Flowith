...
const DOCK_ITEMS = [
  ...
  },
  {
    ...
    color: "text-purple-400 border-purple-500/20 hover:border-purple-400/50 hover:bg-purple-500/5",
  },
  {
    ...
    color: "text-rose-400 border-rose-500/20 hover:border-rose-400/50 hover:bg-rose-500/5",
  },
  {
